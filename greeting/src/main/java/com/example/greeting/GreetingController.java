...
//use for create restful controller
@RestController
public class GreetingController {
	...
	//Mapping to webserver localhost:8080/greeting
    @GetMapping("/greeting")
    public Greeting greeting(@RequestParam(value = "name", defaultValue = "BubuLuna") String name) {
